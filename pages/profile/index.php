<section>
	<h1 class="smon-section">プロフィール</h1>
	<table class="bordered-table">
		<tbody>
			<tr>
				<td>名前</td>
				<td>終に鮭 (しまい―しゃけ)、鮭、AAAR Salmon</td>
			</tr>
			<tr>
				<td>出身</td>
				<td>兵庫県</td>
			...
			<tr>
				<td>趣味</td>
				<td>競技プログラミング、自作PC</td>
			</tr>
		</tbody>
	</table>
	<p>
		(2020年8月)現在学部1年。岡山大学工学部情報系学科在籍中。新しいものを使うのが好き。電子計算機研究会(OUCRC)所属。
	</p>
	<p>
		競技プログラミングにハマっていて、最近ではほぼ毎週(なんなら連日)AtCoderでコンテストに出ている。(2021年2月)レートは水色。大学在学中に青まで行きたい。
	</p>
</section>
<section>
	<h1 class="smon-section">リンク</h1>
	<ul>
